                ...
                try:
                    ...
                    for site in item_overview.websites:
                        if TARGET_DOMAIN in site.url:
                            if site.autofill_behavior == AutofillBehavior.EXACTDOMAIN: continue
                            matching_site = True
                            break
                    ...
                    # Set autofill behavior to EXACTDOMAIN to all matching sites in this item
                    for site in item.websites:
                        if TARGET_DOMAIN in site.url:
                            site.autofill_behavior = AutofillBehavior.EXACTDOMAIN
